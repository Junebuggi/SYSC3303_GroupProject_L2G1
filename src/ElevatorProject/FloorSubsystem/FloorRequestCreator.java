...
public class FloorRequestCreator{
	...
	/**
	 * This method will print nRequests with the specified parameters with a chronological
	 * 5-15 second difference in time stamps
	 * 
...
public static void main(String[] args) {
	printFloorRequest(Information.NUM_FLOORS, Information.NUM_ELEVATOR, 100);
}
}
